 ...
 * @since 100.0.2
 */
class Blog extends \Magento\Framework\View\Element\AbstractBlock implements
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function __construct(
        ...
        \Custom\Blog\Model\Blog $page,
        \Magento\Cms\Model\Template\FilterProvider $filterProvider,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Custom\Blog\Model\BlogFactory $pageFactory,
     ...
     * @return void
     */
    protected function _addBreadcrumbs(\Custom\Blog\Model\Blog $page)
    {
        ...
        if ($this->_scopeConfig->getValue('web/default/show_cms_breadcrumbs', ScopeInterface::SCOPE_STORE)
            ...
            $breadcrumbsBlock->addCrumb('cms_blog', ['label' => $page->getTitle(), 'title' => $page->getTitle()]);
        }
    }
    ...
    {
        return [\Custom\Blog\Model\Blog::CACHE_TAG . '_' . $this->getPage()->getId()];
    }
}
